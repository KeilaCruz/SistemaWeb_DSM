# Generated by Django 4.2.5 on 2024-07-24 19:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archivo', models.FileField(blank=True, null=True, upload_to=gestion_pacientes.models.ruta_hoja_clinica)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archivo', models.FileField(blank=True, null=True, upload_to=gestion_pacientes.models.ruta_documentNutricion)),
                ('idPaciente', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='gestion_pacientes.paciente')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archivo', models.FileField(blank=True, null=True, upload_to=gestion_pacientes.models.ruta_fichapsico_nino)),
                ('idPaciente', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='gestion_pacientes.paciente')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archivo', models.FileField(blank=True, null=True, upload_to=gestion_pacientes.models.ruta_fichapsico_adulto)),
                ('idPaciente', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='gestion_pacientes.paciente')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archivo', models.FileField(blank=True, null=True, upload_to=gestion_pacientes.models.ruta_examen_medico)),
                ('idPaciente', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='gestion_pacientes.paciente')),
        ...
        migrations.AddField(
            model_name='usuario',
            name='idRol',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='gestion_pacientes.rol'),
        ),
    ]
