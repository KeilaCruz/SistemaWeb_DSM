...
export function AddHistorialNutricion() {
    ...
    return (
        <>
            <FormHistoriaNutricion register={register} onSubmit={onSubmit} pacienteSelect={pacienteSelect} setPacienteSelect={setPacienteSelect} errors={errors} trigger={trigger}/>
        </>
    )
}
