                ...
                <div className='container-fluid align-items-center'>
                    <div className='row g-2'>
                        <div className='col-md-3 offset-md-1'>
                            ...
                            <input className='form-control input-form' id='expediente_ficha' value={ficha.expedienteFicha} disabled={true} />
                        </div>
                        <div className='col-md-3 mx-4'>
                            <label className='form-label label-form' htmlFor='expediente_ficha'>Fecha de registro</label>
                            <input className='form-control input-form' id='expediente_ficha' value={ficha.fecha_registro} disabled={true} />
                        </div>
                        <div className='col-md-3 mx-4'>
                        ...
                        <div className='col-md-2 offset-md-1 mt-2'>
                            ...
                            <input className="form-control input-form" id="sintomas_psicomaticos" value={textoPsicomaticos} disabled={true} />
                        </div>
                        {tienePsicomaticos && (
                            <div className='row g-2'>
                                <div className='col-md-3 offset-md-1 mt-2'>
                                    <label className="form-label label-form" htmlFor="cuales_psicomaticos">Cuales sintomas psicomaticos:</label>
                                    <input className="form-control input-form" id="cuales_psicomaticos" value={ficha.datos_medico_quirurgica.cuales_psicomaticos} disabled={true} />
                                </div>
                                <div className='col-md-3 mx-4 mt-2'>
                                    <label className="form-label label-form" htmlFor="bajo_tratamiento">Bajo tramiento:</label>
                                    <input className="form-control input-form" id="bajo_tratamiento" value={textoTratamientoPsicomatico} disabled={true} />
                                </div>
                                <div className='col-md-3 mx-4 mt-2'>
                                    <label className="form-label label-form" htmlFor="cual_tratamiento">Cuál tratamiento:</label>
                                    <input className="form-control input-form" id="cual_tratamiento" value={ficha.datos_medico_quirurgica.cual_tratamiento} disabled={true} />
                                </div>
                            </div>
                        )}
                        <div className='col-md-3 offset-md-1 mt-2'>
                            <label className="form-label label-form" htmlFor="intervenido_quirurgicamente">Ha tenido alguna intervención quirurgica:</label>
                            <input className="form-control input-form" id="ntervenido_quirurgicamente" value={textoIntervencionQuirurgica} disabled={true} />
                        </div>
                        <div className='col-md-3 mx-4 mt-2'>
                            <label className="form-label label-form" htmlFor="tiene_adicciones">Tiene adicciones o ha tenido adicciones:</label>
                            <input className="form-control input-form" id="tiene_adicciones" value={textoAdicciones} disabled={true} />
                        </div>
                        <div className='col-md-3 mx-4 mt-2'>
                            ...
                            <input className="form-control input-form" id="tiene_adicciones" value={textoAtencionMedica} disabled={true} />
                        </div>
                        <div className='col-md-3 offset-md-1 mt-2'>
                            <label className="form-label label-form" htmlFor="especificar_atencion_medica_adecuada">Especificar:</label>
                            <input className="form-control input-form" id="especificar_atencion_medica_adecuada" value={ficha.datos_medico_quirurgica.especificar} disabled={true} />
                        </div>
                        <div className='col-md-3 mx-4 mt-2'>
                        ...
                        <div className='col-md-3 mx-4 mt-2'>
                            ...
                            <input className="form-control input-form" id="experiencia_abuso" value={textoAbusoSexual} disabled={true} />
                        </div>
                        <div className='col-md-3 mx-4 mt-2'>
                            <label className="form-label label-form" htmlFor="sexualmente_activo">Sexualmente activo:</label>
                            <input className="form-control input-form" id="sexualmente_activo" value={textoActivoSexualmente} disabled={true} />
                        </div>
                        {sexualmenteActivo && (
                            <div>
                                ...
                                <div className='col-md-4'>
                                    ...
                                    <input className="form-control input-form" id="con_quien_primera" value={ficha.datos_sexual.con_quien_primera} disabled={true} />
                                </div>
                                <div className='col-md-4'>
                                    ...
                                    <input className="form-control input-form" id="como_hansido_experiencia_sexual" value={ficha.datos_sexual.como_hansido_experiencia_sexual} disabled={true} />
                                </div>
                                <div className='col-md-4'>
                                    <label className="form-label label-form" htmlFor="utiliza_metodo_conceptivo">Utiliza metodo conceptivo:</label>
                                    <input className="form-control input-form" id="utiliza_metodo_conceptivo" value={textoMetodoConceptivo} disabled={true} />
                                </div>
                                {utilizaConceptivo && (
                                    <div>
                                        <div className='col-md-4'>
