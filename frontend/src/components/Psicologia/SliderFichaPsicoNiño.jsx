                    ...
                    {ficha.map(ficha => (
                        <div className="container-fluid">
                            <div className="row align-items-center">
                                ...
                                <div className="col-md-3 mt-2 offset-md-1">
                                ...
                                <div className="col-md-2 mt-2">
                                    ...
                                    <select id="escolaridad-padre" className="form-select input-form" value={ficha.datos_generales.escolaridad_padre} disabled={true}>
                                ...
                                <div className="col-md-2">
                                    ...
                                    <select className="form-select input-form" id="escolaridad-madre" value={ficha.datos_generales.escolaridad_madre} disabled={true}>
                                        <option value="Primaria">Primaria</option>
                                        <option value="Secundaria">Secundaria</option>
                                        <option value="Bachillerato">Bachillerato</option>
                                        <option value="Bachillerato">Licenciatura</option>
                                ...
                                <div className="col-md-4">
                                    <label htmlFor="ocupacion_madre" className="form-label label-form">Ocupación</label>
                                ...
                                <div className="col-md-7 mt-4 mx-4">
                                ...
                                <div className="col-md-3 offset-md-1 mt-2">
                                    ...
                                    <input className="form-control input-form" type="text" id="toma_medicamento" value={textoTomaMedicamento} disabled={true} />
                                </div>
                                <div className="col-md-7 mx-4 mt-4">
                                ...
                                <div className="col-md-2 offset-md-1 mt-2">
                                    <label htmlFor="num_embarazos" className="form-label label-form">No. embarazos </label>
                                ...
                                <div className="col-md-2 mx-4 mt-2">
                                    <label htmlFor="tiempo_gestacion" className="form-label label-form">Tiempo gestación</label>
                                ...
                                <div className="col-md-3 offset-md-1 mt-2">
                                    ...
                                    <input className="form-control input-form" type="text" id="medicamentos_embarazo" value={textoMedicamentoEmbarazo} disabled={true} />
                                </div>
                                ...
                                <div className="col-md-3 mx-4 mt-2">
                                    ...
                                    <input type="text" className="form-control input-form" id="alimentacion_seno_materno" value={textoAlimentacionSeno} disabled={true} />
                                </div>
                                <div className="col-md-3 mx-4 mt-2">
                                ...
                                <div className="col-md-3 mx-4 mt-2">
                                    ...
                                    <input className="form-control input-form" type="text" id="control_esfinger" value={textoControlEsfinger} disabled={true} />
                                </div>
                                <div className="col-md-3 offset-md-1 mt-2">
