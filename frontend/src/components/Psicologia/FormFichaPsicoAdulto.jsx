            ...
            <div className="container-fluid pb-4">
                ...
                <form onSubmit={onSubmit}>
                    {currentPage === 1 && (
                        <div className="row">
                            ...
                            <div className="col-md-4 offset-md-1 mt-1">
                                ...
                                <input id="code_expediente " type="text" placeholder="Número de expediente" className="form-control " {...register("expedienteFicha", { required: true, pattern: /^[A-Za-z0-9]$/ })} />
                            ...
                            <div className="col-md-4 offset-md-1 mt-1">
                                ...
                                <input id="religion" type="text" placeholder="Religión" className="form-control " {...register("religion", { required: true, pattern: /^[A-Za-z .°,ÁÉÍÓÚáéíóú\d]$/ })} />
                            ...
                            {showHijos && (
                                <div className="row">
                                    <div className="col-md-4 offset-md-1 mt-1">
                                        ...
                                        <input id="num_hijos" className="form-control " type="number" placeholder="Número" {...register("numero_hijos")} />
                                    ...
                                    <div className="col-md-4 offset-md-1 mt-1">
                                        ...
                                        <input id="edad_hijos" className="form-control " type="text" placeholder="Edad" {...register("edad_hijos", { pattern: /^[A-Za-z ,ÁÉÍÓÚáéíóú\d]$/ })} />
                                    ...
                                    <div className="col-md-4 offset-md-1 mt-1">
                                        ...
                                        <input id="ocupacion" type="text" placeholder="Ocupación" className="form-control " {...register("ocupacion_hijos", { pattern: /^[A-Za-z ,ÁÉÍÓÚáéíóú]$/ })} />
                            ...
                            <div className="col-md-4 offset-md-1 mt-1">
                                ...
                                <input id="ocupacion" type="text" placeholder="Ocupación" className="form-control " {...register("ocupacion", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú\d]$/ })} />
                            ...
                            <div className="col-md-4 offset-md-1 mt-1">
                                ...
                                <input type="text" placeholder="Nivel socioeconómico" className="form-control " {...register("nivel_socioeconomico", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú\d]$/ })} />
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <textarea id="motivo_consulta" className="form-control " placeholder="Motivo de consulta" {...register("motivo_consulta", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;\d]$/ })}></textarea>
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <input id="referido" type="text" placeholder="Referido por" className="form-control " {...register("referido", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú]$/ })} />
                            ...
                            {showAtencionPsico && (
                                <div className="row">
                                    <div className="col-md-4 offset-md-1 mt-1">
                                        ...
                                        <textarea id="motivos_orientacion" className="form-control " placeholder="Motivos" {...register("motivos_orientacion", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;\d]$/ })}></textarea>
                                    ...
                                    <div className="col-md-4 offset-md-1 mt-1">
                                        ...
                                        <input id="tiempo_orientacion" className="form-control " type="text" placeholder="Semanas, días, años" {...register("tiempo_orientacion", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú\d]$/ })} />
                    ...
                    {currentPage === 2 && (
                        <div className="row">
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <textarea id="historia_actual" className="form-control " placeholder="Historia actual del paciente" {...register("historia_actual_paciente", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;\d]$/ })}></textarea>
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <textarea id="historia_desarrollo" className="form-control " placeholder="Historia de desarrollo" {...register("historia_desarrollo", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;\d]$/ })}></textarea>
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <textarea id="des_primeros_años" className="form-control " placeholder="Primero cuatro años" {...register("primeros_cuatro_años", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;\d]$/ })}></textarea>
                    ...
                    {currentPage === 3 && (
                        <div className="row">
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <textarea id="historia_escolar_kinder" className="form-control " placeholder="Historia escolar en el kinder" {...register("historia_escolar_kinder", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;\d]$/ })}></textarea>
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <textarea id="historia_escolar_primaria" className="form-control " placeholder="Historia escolar en la primaria" {...register("historia_escolar_primaria", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;\d]$/ })}></textarea>
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <textarea id="historia_escolar_secundaria" className="form-control " placeholder="Historia escolar en la secundaria" {...register("historia_escolar_secundaria", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;\d]$/ })}></textarea>
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <textarea id="historia_escolar_prepa" className="form-control " placeholder="Historia escolar en la preparatoria" {...register("historia_escolar_preparatoria", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;\d]$/ })}></textarea>
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <textarea id="historia_escolar_profesional" className="form-control " placeholder="Historia escolar profesional" {...register("historia_escolar_profesional", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;\d]$/ })}></textarea>
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <textarea id="hsitoria_laboral" className="form-control " placeholder="Historia laboral" {...register("historia_laboral", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;\d]$/ })}></textarea>
                            ...
                            <div className="col-md-4 offset-md-1 mt-1">
                                ...
                                <input id="gusta_trabajo" className="form-control " type="text" placeholder="Gusta del trabajo" {...register("gusta_trabajo", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;\d]$/ })} />
                            ...
                            <div className="col-md-4 offset-md-1 mt-1">
                                ...
                                <input id="no_gusta_trabajo" className="form-control " type="text" placeholder="No gusta del trabajo" {...register("no_gusta_trabajo", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;\d]$/ })} />
                    ...
                    {currentPage === 4 && (
                        <div className="row">
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <input id="percepcion padres" className="form-control " type="text" placeholder="Percepción de los padres" {...register("percibe_padres", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;]$/ })} />
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <input id="que_contado_padres" className="form-control " type="text" placeholder="Que le han contado" {...register("contado_padres", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;]$/ })} />
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <input id="percepcion_vive" className="form-control " type="text" placeholder="Percepción de los que vive con usted" {...register("percibe_vive_casa", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;]$/ })} />
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <input id="percepcion_hijos" className="form-control " type="text" placeholder="Percepción de los hijos" {...register("percibe_hijos", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;]$/ })} />
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <input id="otros-familiares_significativos" className="form-control " type="text" placeholder="Otros familiares significativos" {...register("otros_familiares_significativos", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;]$/ })} />
                    ...
                    {currentPage === 5 && (
                        <div className="row">
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <input id="padecimientos_heredofamiliares" className="form-control " type="text" placeholder="padecimientos heredofamiliares" {...register("padecimientos_heredofamiliares", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;]$/ })} />
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <input id="enfermedades_padecido" className="form-control " type="text" placeholder="enfermedades que ha padecido" {...register("enfermedades_padecido", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;]$/ })} />
                            ...
                            {showPsicomaticos && (
                                <div className="col-md-4 offset-md-1">
                                    ...
                                    <input id="cuales_psicomaticos" className="form-control " type="text" placeholder="Cuáles sintomas o transtornos psicomaticos" {...register("cuales_psicomaticos", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;]$/ })} />
                            ...
                            {showCronica && (
                                <div className="col-md-4 offset-md-1">
                                    ...
                                    <input id="cual_cronica" className="form-control " type="text" placeholder="Cuál enfermedad crónica" {...register("cual_cronica", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;]$/ })} />
                                </div>
                            )}
                            <div className=" col-md-9 offset-md-1">
                            ...
                            {showAdiccion && (
                                <div className="col-md-4 offset-md-1">
                                    ...
                                    <input className="form-control " id="cual_adiccion" type="text" placeholder="Cuál adicción" {...register("cual_adiccion", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;]$/ })} />
                            ...
                            <div className="col-md-9 offset-md-1 mt-2">
                                ...
                                <textarea className="form-control " id="otros_datos" placeholder="Otros datos" {...register("otros_datos", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;]$/ })}></textarea>
                            ...
                            <div className="col-md-9 offset-md-1">
                                ...
                                <textarea className="form-control " id="calidad_atencion_medica" placeholder="Especificar" {...register("especificar", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;\d]$/ })}></textarea>
                                {errors.otros_datos?.type === "required" &&
                                    (
                                        <p className="mt-2 mb-2 text-informativo"> <i class="lni lni-warning"></i> Ingrese el campo</p>
                                    )
                    ...
                    {currentPage === 6 && (
                        <div className="row">
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <input className="form-control " id="cuando_diferencia_genero" type="text" placeholder="¿Cuándo noto la diferencia de genero?" {...register("cuando_diferencia_genero", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú\d]$/ })} />
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <input className="form-control " id="como_diferencia_genero" type="text" placeholder="¿Cómo se dio cuenta de la diferencia de genero?" {...register("como_diferencia_genero", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú,.;\d]$/ })} />
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <input className="form-control " id="cual_genero_niño" type="text" placeholder="¿Cuál se le asignó de niño?" {...register("genero_asignaron_niño", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú]$/ })} />
                            ...
                            {showAbusoSexual && (
                                <div className="row">
                                    ...
                                    <div className="col-md-4 offset-md-1 mt-1">
                                        ...
                                        <input id="por_quien_abuso" className="form-control " type="text" placeholder="¿Por quién sufrió dicho abuso?" {...register("por_quien_abuso_sexual", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú]$/ })} />
                            ...
                            {showSexualActivo && (
                                <div className="row">
                                    <div className="col-md-4 offset-md-1 mt-1">
                                        ...
                                        <input id="edad_primera_relacion_sexual" className="form-control " type="number" placeholder="Edad" {...register("edad_primera_relacion_sexual")} />
                                    ...
                                    <div className="col-md-4 offset-md-1 mt-1">
                                        ...
                                        <input className="form-control " id="quien_primera_relacion_sexual" type="text" placeholder="¿Con quién?" {...register("con_quien_primera", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú]$/ })} />
                                    ...
                                    <div className="col-md-9 offset-md-1 mt-1">
                                        ...
                                        <input id="experiencia_sexual" className="form-control " type="text" placeholder="¿Cómo han sido?" {...register("como_hansido_experiencia_sexual", { pattern: /^[A-Za-z ,.;ÁÉÍÓÚáéíóú]$/ })} />
                            ...
                            {showMetodoConceptivo && (
                                <div className="col-md-4 offset-md-1 mt-1">
                                    ...
                                    <input id="cual_conceptivo" className="form-control " type="text" placeholder="Cuál método conceptivo" {...register("cual_metodo_conceptivo", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú]$/ })} />
                            ...
                            {isFemenino && (
                                <div className="row">
                                    ...
                                    <div className="col-md-4 offset-md-1 mt-1">
                                        ...
                                        <input id="info_tenia_menarca" className="form-control " type="text" placeholder="¿Que información tenia?" {...register("informacion_tenia_menarca", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú]$/ })} />
                                    ...
                                    <div className="col-md-4 offset-md-1 mt-1">
                                        ...
                                        <input id="proporcion_info_menarca" className="form-control " type="text" placeholder="¿Quién le proporciono esa información?" {...register("quien_dio_info_menarca", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú]$/ })} />
                                    ...
                                    <div className="col-md-4 offset-md-1 mt-1">
                                        ...
                                        <input id="como_info-menarca" className="form-control " type="text" placeholder="¿Cómo recibio esa información?" {...register("como_recibio_info_menarca", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú]$/ })} />
                            ...
                            {isMasculino && (
                                <div className="row">
                                    <div className="col-md-4 offset-md-1 mt-1">
                                        ...
                                        <input id="edad_primera_eyaculacion" className="form-control " type="number" placeholder="Edad" {...register("edad_primeras_eyaculaciones_nocturnas")} />
                                    ...
                                    <div className="col-md-4 offset-md-1 mt-1">
                                        ...
                                        <input id="info_tenia_eyaculacion" className="form-control " type="text" placeholder="¿Que informacion tenia?" {...register("informacion_tenia_eyaculacion", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú]$/ })} />
                                    ...
                                    <div className="col-md-4 offset-md-1 mt-1">
                                        ...
                                        <input id="quien_dio_info" className="form-control " type="text" placeholder="¿Quién le proporciono esa información?" {...register("quien_dio_info_eyaculacion", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú]$/ })} />
                                    ...
                                    <div className="col-md-4 offset-md-1 mt-1">
                                        ...
                                        <input id="como_info_eyaculacion" className="form-control " type="text" placeholder="¿Cómo recibio esta información?" {...register("como_recibio_info_eyaculacion", { pattern: /^[A-Za-z ÁÉÍÓÚáéíóú]$/ })} />
                            ...
                            <div className="col-md-9 offset-md-1 mt-1">
                                ...
                                <input id="cual_relacion" className="form-control " type="text" placeholder="¿Cuál relación?" {...register("tenido_relaciones_distintas_heterosexuales", { required: true, pattern: /^[A-Za-z ÁÉÍÓÚáéíóú]$/ })} />
                    ...
                    <div className=" col-md-9 mt-4 d-flex  offset-md-1 justify-content-between">
                        ...
                        {currentPage < 6 && <button type="button" className="btn rounded button-pagination" onClick={handleNextPage}>Siguiente</button>}
                        {currentPage === 6 && <button type="submit" className="button-guardar btn rounded">Enviar</button>}
                    </div>
                </form>
            </div>
        </>
