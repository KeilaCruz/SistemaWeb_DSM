...
export function AddFichaPsiNiño() {
    ...
    const onSubmit = handleSubmit(async (data) => {
        ...
        formData.append('antecedentes_padecimiento', JSON.stringify({
        ...
        formData.append('antecedentes_desarrollo', JSON.stringify({
        ...
        formData.append('datos_escolares', JSON.stringify({
        ...
        try {
            ...
            const response = await registerFichaPsiNiño(formData);
